<?php 
	...
	class Dashboard extends Controllers{
		...
		{
			$data['page_id'] = 2;
			$data['page_tag'] = "Dashboard - AGROSET S.A";
			$data['page_title'] = "Dashboard - AGROSET S.A";
			...
			$data['gastoPorCliente'] = $this->model->gastoPorCliente();

			$data['lastOrders1'] = $this->model->lastOrders1();

			$anio = date('Y');
			$mes = date('m');

			$data['selectProductosPorCategoria'] = $this->model->selectProductosPorCategoria($anio,$mes);

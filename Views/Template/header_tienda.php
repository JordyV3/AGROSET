...
<head>
	...
	<link rel="shortcut icon" href="<?= media();?>/tienda/images/icono.png">
	...
	<?php 
		...
		$urlWeb = base_url();
		$urlImg = media()."/tienda/images/icono.png";
...
<!--===============================================================================================-->	
	<!-- <link rel="icon" type="image/png" href="<?= media() ?>/tienda/images/agroset.png"/> -->
	<link rel="icon" type="image/x-icon" href="/tienda/images/icono.png">
<!--===============================================================================================-->
...
<body class="animsition">
	...
	<div id="divLoading" >
      <div>
        <img style="heinth" src="<?= media(); ?>/images/loading.svg" alt="Loading">
      </div>
    </div>
	<!-- Header -->
	<header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<img src="<?= media() ?>/tienda/images/agroset.png" alt="AGROSET S.A" style="height: 100px;">
					</a>
					<!-- Menu desktop -->
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?= base_url(); ?>"><img src="<?= media() ?>/tienda/images/agroset.png" alt="AGROSET S.A"></a>
			</div>

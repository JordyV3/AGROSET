...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="GEFARM STORE">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Jordy Vega">
    <meta name="theme-color" content="#009688">
    <link rel="shortcut icon" href="<?= media();?>/images/icono.png">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">AGROSET S.A</a>
    <!-- <header class="app-header"><header class="app-header">
    <a class="app-header__logo" href="<?= base_url(); ?>/dashboard">
        <img src="<?= media() ?>/tienda/images/agroset.png" alt="AGROSET S.A" style="height: 50px;">
    </a> -->
